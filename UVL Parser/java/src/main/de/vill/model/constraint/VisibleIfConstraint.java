...
public class VisibleIfConstraint extends Constraint {
    private Constraint left;
    private Constraint right;

    public VisibleIfConstraint(Constraint left, Constraint right) {
        this.left = left;
        this.right = right;
    }
    ...
    public Constraint clone() {
        return new VisibleIfConstraint(left.clone(), right.clone());
    }
    ...
    public boolean equals(Object obj) {
        ...
        VisibleIfConstraint other = (VisibleIfConstraint) obj;
